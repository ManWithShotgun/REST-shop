...
import ru.ilia.rest.model.util.MonitorListJson;
...
public class MonitorsRS {
    ...
    public Response getMonitors(@DefaultValue("10")@QueryParam("limit") int limit,
        ...
        try {
            ...
            return Response.ok(toJson(new MonitorListJson(metaPagination,products))).build();
    ...
    private String toJson(MonitorListJson monitorListJson) throws JsonProcessingException {
        ObjectMapper objectMapper=new ObjectMapper();
        return objectMapper.writeValueAsString(monitorListJson);
